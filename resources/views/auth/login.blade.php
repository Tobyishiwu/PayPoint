<x-guest-layout>
    <div style="width: 100%; max-width: 400px; background: white; padding: 30px; border-radius: 24px; border: 1px solid #EAECF0;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="font-size: 14px; color: #667085; margin: 0;">Login to your PayPoint account</p>
        </div>
            ...
            <div style="margin-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" style="font-size: 12px; color: #2B64E3; font-weight: 800; text-decoration: none;">Forgot?</a>
                    @endif
                </div>
        ...
        @if (Route::has('register'))
            <p style="text-align: center; margin-top: 25px; font-size: 14px; color: #667085;">
                New here? <a href="{{ route('register') }}" style="color: #2B64E3; font-weight: 800; text-decoration: none;">Register Account</a>
            </p>
        @endif
    </div>
</x-guest-layout>
